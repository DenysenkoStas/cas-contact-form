...
class CAS_CF_Shortcode {
	...
	public function render( $atts ): string {
      ...
      <div class="cas-cf-wrapper" id="cas-cf-wrapper">
        ...
        <!-- Step indicator -->
        <div class="cas-cf-steps d-flex align-items-center justify-content-center mb-4">
			<?php for ( $i = 1; $i <= 3; $i ++ ) : ?>
          ...
          <div class="cas-cf-panel active" data-panel="1">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    <label for="cas_first_name"
                           class="form-label"><?php esc_html_e( 'First name', 'cas-contact-form' ); ?> <span
                        class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="cas_first_name" name="first_name" placeholder="John"
                           required>
                    <div class="invalid-feedback" id="err-first_name"></div>
                  </div>
                  <div class="col-md-6">
                    <label for="cas_last_name"
                           class="form-label"><?php esc_html_e( 'Last name', 'cas-contact-form' ); ?> <span
                        class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="cas_last_name" name="last_name" placeholder="Doe"
                           required>
                ...
                <div class="mt-3">
                  <label for="cas_email" class="form-label"><?php esc_html_e( 'Email', 'cas-contact-form' ); ?> <span
                      class="text-danger">*</span></label>
                  <input type="email" class="form-control" id="cas_email" name="email" placeholder="john@example.com"
                         required>
                  <div class="invalid-feedback" id="err-email"></div>
                </div>

                <div class="mt-3">
                  <label for="cas_phone" class="form-label"><?php esc_html_e( 'Phone', 'cas-contact-form' ); ?> <span
                      class="text-danger">*</span></label>
                  <input type="tel" class="form-control" id="cas_phone" name="phone" placeholder="+380 (XX) XXX-XX-XX"
                         required>
          ...
          <div class="cas-cf-panel" data-panel="2">
            <div class="card">
              <div class="card-body">
                ...
                <div>
                  <label for="cas_country" class="form-label"><?php esc_html_e( 'Country', 'cas-contact-form' ); ?>
                    <span class="text-danger">*</span></label>
                  <select class="form-select" id="cas_country" name="country" required>
                    <option value=""><?php esc_html_e( 'Select country...', 'cas-contact-form' ); ?></option>
                ...
                <div class="mt-3">
                  <label for="cas_city" class="form-label"><?php esc_html_e( 'City', 'cas-contact-form' ); ?> <span
                      class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="cas_city" name="city" placeholder="Odessa" required>
              ...
              <div class="card-body">
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="cas_terms">
                    ...
                    <a href="#" target="_blank"><?php esc_html_e( 'Terms and Conditions', 'cas-contact-form' ); ?></a>
                ...
                <div class="d-flex justify-content-between mt-4">
                  ...
                  <button type="submit" class="btn btn-primary" id="cas-cf-submit">
